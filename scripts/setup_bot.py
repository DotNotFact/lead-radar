...
COMMANDS = [
    ...
    BotCommand(command="export_ai", description="Лиды для ИИ: /export_ai [дней]"),
    ...
    BotCommand(command="ai_leads", description="Лиды, которые можно закрыть с помощью ИИ"),
    ...
    BotCommand(command="prompts", description="Список промптов для внешнего ИИ"),
    BotCommand(command="prompt", description="Получить текст промпта: /prompt имя"),
